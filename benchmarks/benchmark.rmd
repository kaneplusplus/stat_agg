...
z=data.frame(misclass_rate=misclass_rate, learners=2:(length(misclass_rate)+1))
qplot(x=learners, y=misclass_rate, data=z, geom="point") +
  geom_abline(intercept=min(indiv_misclass), slope=0, color="red") +
  xlab("Number of Learners") + ylab("Misclassification Rate")
```
...
z=data.frame(mse=mse, learners=2:(length(mse)+1))
qplot(x=learners, y=mse, data=z, geom="point") +
  xlab("Number of Learners") + ylab("Mean Square Error") +
  geom_abline(intercept=min(indiv_mse), slope=0, color="red")
```
